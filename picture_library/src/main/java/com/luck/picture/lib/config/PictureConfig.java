...
public final class PictureConfig {
    ...
    public final static String CHOOSEORIGINAL = "isChooseOriginal";
    ...
    public final static int DOODLE_REPLACE_PATH = 2775; //编辑图片后替换原来的图片路径
    ...
    public final static int TYPE_IMAGE_AND_VIDEO = 4;
    ...
    public final static int DOODLE_EDITOR = 101;
}
